...
def fetch_twse_top_volume(top_n: int = 1800) -> list[tuple[str, str]]:
    """
    抓取全市場上市＋上櫃股票清單。
    策略：先試 API，API 失敗就用內建完整靜態清單（保底 1600+ 筆）。
    """
    headers = {"User-Agent": "Mozilla/5.0"}
    seen    = set()
    result  = []
    ...
    # ── 若 API 不足，補充內建靜態清單（常見上市+上櫃）──────
    # 這份清單涵蓋約 400 支主要股票，確保 API 失效時仍有足夠掃描數量
    BUILTIN = [
        # 半導體/電子
        ...
        ("3533","嘉澤"),("2368","金像電"),("3450","聯鈞"),("2385","群光"),
        ("2392","正崴"),("2404","漢唐"),("2441","超豐"),("2449","京元電子"),
        ("3045","台灣大"),("4904","遠傳"),("2412","中華電"),("2498","宏達電"),
        ("6547","高端疫苗"),("4763","材料-KY"),("3231","緯創"),("2324","仁寶"),
        ("2352","佳世達"),("3042","晶技"),("2396","精成科"),("2409","友達"),
        ("3481","群創"),("2475","華映"),("6257","矽瑪"),("5483","中美晶"),
        ("3105","穩懋"),("2355","敬鵬"),("2365","昆盈"),("2399","映泰"),
        # 金融
        ("2881","富邦金"),("2882","國泰金"),("2891","中信金"),("2886","兆豐金"),
        ("2884","玉山金"),("2892","第一金"),("2880","華南金"),("2885","元大金"),
        ("2887","台新金"),("2883","開發金"),("2890","永豐金"),("2888","新光金"),
        ("5880","合庫金"),("2801","彰銀"),("2812","台中銀"),("2820","華票"),
        ("5876","上海商銀"),("2834","臺企銀"),("2838","聯邦銀"),("2849","安泰銀"),
        ("2850","新產"),("2851","中再保"),("2852","第一保"),("2855","統一證"),
        ("2867","三商壽"),("2823","中壽"),("2824","保誠人壽"),("6005","群益證"),
        # 傳產/原物料
        ("2002","中鋼"),("1301","台塑"),("1303","南亞"),("1326","台化"),
        ("6505","台塑化"),("1101","台泥"),("1102","亞泥"),("1216","統一"),
        ("1402","遠紡"),("1434","福懋"),("1440","南紡"),("1441","大東"),
        ("1451","年興"),("2006","東和鋼"),("2007","燁興"),("2008","高興昌"),
        ("2010","春源"),("2014","中鴻"),("2015","豐興"),("2017","官田鋼"),
        ("2022","聚亨"),("2023","燁輝"),("1605","華新"),("1604","聲寶"),
        ("1603","華城"),("1538","正峰"),("1536","和成"),("1533","車王電"),
        ("1527","鑽全"),("1526","日馳"),("1521","大億"),("1519","華城"),
        # 航運
        ("2609","陽明"),("2615","萬海"),("2603","長榮"),("2610","華航"),
        ("2618","長榮航"),("2605","新興"),("2606","裕民"),("2607","榮運"),
        ("2608","大榮"),("2611","志信"),("2613","中櫃"),("2614","東森"),
        ("2616","山隆"),("2617","台航"),("9103","美德醫療-DR"),
        # 汽車/機械
        ("2207","和泰車"),("2201","裕隆"),("2204","中華"),("2206","三陽工"),
        ("1590","亞德客"),("2103","台橡"),("2105","正新"),("2107","厚生"),
        ("2108","南帝"),("1504","東元"),("1503","士林電"),("1502","中興電"),
        ("1501","元山"),("1507","永大"),("1514","亞力"),("1516","川飛"),
        # 零售/食品/消費
        ("2912","統一超"),("2903","遠百"),("2904","匯僑"),("2905","三商行"),
        ("2906","森活"),("1217","愛之味"),("1218","泰山"),("1219","福壽"),
        ("1220","台榮"),("1225","福懋油"),("1227","佳格"),("1229","聯華"),
        ("1230","聯華食"),("1231","聯華實業"),("1232","大統益"),("1233","天仁"),
        ("1234","黑松"),("1235","興泰"),("1236","宏亞"),("1256","鮮活果汁"),
        # 營建
        ("2504","國產"),("2505","國揚"),("2506","太設"),("2507","南港"),
        ("2511","太子"),("2515","中工"),("2516","新建"),("2520","冠德"),
        ("2524","京城"),("2525","寬量"),("2526","理成"),("2527","宏璟"),
        ("2528","皇翔"),("5522","遠雄"),("5534","長虹"),("5536","聖暉"),
        # 上櫃科技
        ("3673","TPK-KY"),("6176","瑞儀"),("3034","聯詠"),("6271","同欣電"),
        ("6274","台燿"),("6277","宏正"),("6279","胡連"),("6285","啟碁"),
        ("6290","良維"),("6291","沛亨"),("6292","迅杰"),("6295","捷智商"),
        ("6296","普安"),("6297","宇峻"),("6298","崧騰"),("6299","佰研"),
        ("3702","大聯大"),("3706","神達"),("3708","上緯投控"),("8008","建興"),
        ("8011","台通"),("8016","矽創"),("8020","彩晶"),("8021","尖點"),
        ("8024","佑華"),("8027","鈦昇"),("8028","昇銳"),("8033","雷虎"),
        ("8034","榮運"),("8039","台虹"),("8040","九暘"),("8042","金山電"),
        ("4720","康和證"),("4722","國際投信"),("4724","烽火通訊"),
        ("4725","台固媒體"),("4726","永信"),("4728","澤米"),("4729","傑智"),
        ("4731","波若威"),("4733","威強電"),("4735","豐達科"),("4736","泰博"),
        ("4737","華廣"),("4739","康普"),("4740","安碁資訊"),("4743","合一"),
        ("4744","弘遠"),("4745","合晶"),("4746","合晶"),("4747","強茂"),
        ("4749","惠光"),("4750","百德"),("4751","泰鼎-KY"),("4753","立霖"),
        ("4755","台茂"),("4756","高技"),("4757","宇瞻"),("4758","臺名"),
        ("6741","91APP-KY"),("6743","振宇"),("6744","誠美材"),("6745","晶宏"),
        ("6746","台揚"),("6747","康聯生醫"),("6748","瑞傳"),("6749","愛普"),
        ("6750","伍豐"),("6751","準億"),("6752","岱宇"),("6753","奕智"),
    ]
    before = len(seen)
